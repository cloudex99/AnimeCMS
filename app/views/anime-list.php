        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-inline" id="anime_filter" method="POST" action="/paginate">
                    <input type="hidden" name="model" value="Anime">
                ...
                <ul class='sync-pagination pagination flex-wrap' data-pages='<?=ceil(Anime::count()/30)?>' data-page='1' data-size='30' data-query='' data-total='<?=Anime::count()?>'></ul>
